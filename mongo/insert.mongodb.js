...
// db.categoria.createIndex({ nome: 1 });

// db.produto.createIndex({ nome: 1 });
// db.produto.createIndex({ categoria: 1 });

// db.avaliacao.createIndex({ produto: 1 });
// db.avaliacao.createIndex({ usuario: 1 });

// db.transacao.createIndex({ produto: 1 });
// db.transacao.createIndex({ usuario: 1 });
...
db.usuario.updateOne(
  { _id: ObjectId("6485e5f9c4d60d43e7b9c0e1") }, // Carlos Santos
  {
    $set: {
      "endereco.localizacao": {
        type: "Point",
        coordinates: [-38.5039, -12.9718], // Coordenadas em Salvador
      },
    },
  }
);
...
db.usuario.updateOne(
  { _id: ObjectId("6485e5f9c4d60d43e7b9c0e2") }, // Maria Silva
  {
    $set: {
      "endereco.localizacao": {
        type: "Point",
        coordinates: [-38.9719, -12.5296], // Coordenadas em Feira de Santana
      },
    },
  }
);
...
db.usuario.updateOne(
  { _id: ObjectId("6485e5f9c4d60d43e7b9c0e3") }, // João Souza
  {
    $set: {
      "endereco.localizacao": {
        type: "Point",
        coordinates: [-40.8235, -14.235], // Coordenadas em Vitória da Conquista
      },
    },
  }
);
